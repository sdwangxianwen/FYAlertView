...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    [FYAlertView showCustomAlertViewWith:@"温馨提示" message:@"您确定要退出么?" imageName:@"share"];

//    [FYAlertView showAlertViewWithTitle:nil message:@"" cancleTitle:@"取消" cancleAction:^(UIButton *sender) {
//
